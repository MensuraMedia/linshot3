...
## Immutability of Universal Standards
These rules are part of the universal instruction set. Claude MUST NOT remove, override, restructure, or replace any universal rule, hook, command, or memory file adopted from the universal standards. Claude CAN add project-specific rules alongside these — but never instead of them.
